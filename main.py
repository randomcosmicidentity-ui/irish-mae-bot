...
def keep_alive():
    ...
    t.daemon = True  # यह थ्रेड को बैकग्राउंड में आसानी से चलने देगा
    t.start()
...
def main():
    # पहले Flask सर्वर को बैकग्राउंड में चालू करें ताकि Render तुरंत कनेक्ट हो सके
    keep_alive()
    ...
    # drop_pending_updates=True पुराने पेंडिंग मैसेजेस के लोड को हटा देगा
